...
export const Dictionary: DictionaryLang = {
  ...
  RU: {
    ...
    formOutcomeTitle: 'Новый расход',
    labelCategory: 'Выберите категорию',
    labelSum: 'Добавьте сумму',
    labelDate: 'Выберите дату',
    labelNote: 'Добавить примечение',
...
export const DictionaryKeys: DictionaryKeysType = {
  ...
  formOutcomeTitle: 'formOutcomeTitle',
